...
namespace GridPerf
{
    ...
    public sealed partial class GroupDetailPage : Page
    {
        ...
        private void ToggleEnabled(bool newState)
        {
            defaultViewModel["RenderPhasesEnabled"] = newState;
            Render.SetUsePhases(this.itemGridView, newState);
        }
    }
}